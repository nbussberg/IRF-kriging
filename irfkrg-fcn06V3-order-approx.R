### Functions to approximate the MoM values for different degrees of non-
    ### homogeneity
##  Created by: Nicholas Bussberg and Jacob Shields
##  Date last updated: 2022-12-12
##  Filename: irf-fcn06V3-order-approx.R
##  Purpose: create the functions to approximate the MoM values for different 
    ## degrees of non-homogeneity based on IRFk theory
