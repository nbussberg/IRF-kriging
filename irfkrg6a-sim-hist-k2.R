### Code that simulates 1000 IRF2 datasets and plots kappa estimation
##  Created by: Nicholas Bussberg
##  Date last updated: 2024-12-16
##  Filename: irfkrg6a-sim-hist-k2.R
##  Purpose: simulates 1000 IRF2 datasets, estimates kappa for each, plot
...
ud <- readRDS("data/irfkrg1-data-r-sig-model-ud-k2.Rds")
